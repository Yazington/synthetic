...
class TestDeprecations(TestCase):
    ...
    def test_version(self):
        ...
        self.assertTrue(str(w.warning).startswith('Accessing jsonschema.__version__ is deprecated'))
    ...
    def test_validators_ErrorTree(self):
        ...
        self.assertEqual(w.filename, __file__)
        self.assertTrue(str(w.warning).startswith('Importing ErrorTree from jsonschema.validators is deprecated'))
    ...
    def test_validators_validators(self):
        ...
        self.assertEqual(w.filename, __file__)
        self.assertTrue(str(w.warning).startswith('Accessing jsonschema.validators.validators is deprecated'))
    ...
    def test_validators_meta_schemas(self):
        ...
        self.assertEqual(w.filename, __file__)
        self.assertTrue(str(w.warning).startswith('Accessing jsonschema.validators.meta_schemas is deprecated'))
    ...
    def test_RefResolver_in_scope(self):
        ...
        with self.assertWarns(DeprecationWarning) as w:
            with resolver.in_scope('foo'):
                pass
        self.assertEqual(w.filename, __file__)
        self.assertTrue(str(w.warning).startswith('jsonschema.RefResolver.in_scope is deprecated '))
    ...
    def test_Validator_is_valid_two_arguments(self):
        ...
        self.assertEqual(w.filename, __file__)
        self.assertTrue(str(w.warning).startswith('Passing a schema to Validator.is_valid is deprecated '))
    ...
    def test_Validator_iter_errors_two_arguments(self):
        ...
        self.assertEqual(w.filename, __file__)
        self.assertTrue(str(w.warning).startswith('Passing a schema to Validator.iter_errors is deprecated '))
