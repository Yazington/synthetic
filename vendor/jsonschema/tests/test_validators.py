...
import unittest
import warnings
__import__('.'.join(__package__.split('.')[:-2] + ['attr']), globals(), locals(), [], 0)
from ... import attr
...
class TestValidationErrorMessages(TestCase):
    ...
    def test_unevaluated_items(self):
        ...
        message = self.message_for(instance=['foo', 'bar'], schema=schema)
        self.assertIn(message, "Unevaluated items are not allowed ('bar', 'foo' were unexpected)")
...
class TestValidationErrorDetails(TestCase):
    ...
    def test_ref(self):
        ...
        validator = validators.Draft7Validator({'$ref': ref}, resolver=validators.RefResolver('', {}, store={ref: schema}))
...
class TestValidate(TestCase):
    ...
    def test_draft3_validator_is_chosen(self):
        self.assertUses(schema={'$schema': 'http://json-schema.org/draft-03/schema#'}, Validator=validators.Draft3Validator)
        self.assertUses(schema={'$schema': 'http://json-schema.org/draft-03/schema'}, Validator=validators.Draft3Validator)

    def test_draft4_validator_is_chosen(self):
        self.assertUses(schema={'$schema': 'http://json-schema.org/draft-04/schema#'}, Validator=validators.Draft4Validator)
        self.assertUses(schema={'$schema': 'http://json-schema.org/draft-04/schema'}, Validator=validators.Draft4Validator)

    def test_draft6_validator_is_chosen(self):
        self.assertUses(schema={'$schema': 'http://json-schema.org/draft-06/schema#'}, Validator=validators.Draft6Validator)
        self.assertUses(schema={'$schema': 'http://json-schema.org/draft-06/schema'}, Validator=validators.Draft6Validator)
    ...
    def test_draft202012_validator_is_chosen(self):
        self.assertUses(schema={'$schema': 'https://json-schema.org/draft/2020-12/schema#'}, Validator=validators.Draft202012Validator)
        self.assertUses(schema={'$schema': 'https://json-schema.org/draft/2020-12/schema'}, Validator=validators.Draft202012Validator)
...
class TestRefResolver(TestCase):
    ...
    def test_it_resolves_local_refs_with_id(self):
        ...
        resolver = validators.RefResolver.from_schema(schema, id_of=lambda schema: schema.get('id', ''))
    ...
    def test_cache_remote_on(self):
        ...
        ref = 'foo://bar'
        resolver = validators.RefResolver('', {}, cache_remote=True, handlers={'foo': handler})
    ...
    def test_cache_remote_off(self):
        ...
        ref = 'foo://bar'
        resolver = validators.RefResolver('', {}, cache_remote=False, handlers={'foo': handler})
        with resolver.resolving(ref):
            pass
