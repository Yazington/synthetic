...
def _split_what(what):
    ...
    """
    return (frozenset((cls for cls in what if isinstance(cls, type))), frozenset((cls for cls in what if isinstance(cls, str))), frozenset((cls for cls in what if isinstance(cls, Attribute))))
