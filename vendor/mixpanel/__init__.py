...
__import__('.'.join(__package__.split('.')[:-1] + ['six']), globals(), locals(), [], 0)
from .. import six
...
class Mixpanel(object):
    ...
    def track(self, distinct_id, event_name, properties=None, meta=None):
        ...
        """
        all_properties = {'token': self._token, 'distinct_id': distinct_id, 'time': self._now(), '$insert_id': self._make_insert_id(), 'mp_lib': 'python', '$lib_version': __version__}
        if properties:
            all_properties.update(properties)
        event = {'event': event_name, 'properties': all_properties}
        if meta:
            event.update(meta)
        self._consumer.send('events', json_dumps(event, cls=self._serializer))

    def import_data(self, api_key, distinct_id, event_name, timestamp, properties=None, meta=None, api_secret=None):
        ...
        all_properties = {'token': self._token, 'distinct_id': distinct_id, 'time': timestamp, '$insert_id': self._make_insert_id(), 'mp_lib': 'python', '$lib_version': __version__}
        if properties:
            all_properties.update(properties)
        event = {'event': event_name, 'properties': all_properties}
        if meta:
    ...
    def alias(self, alias_id, original, meta=None):
        ...
        """
        event = {'event': '$create_alias', 'properties': {'distinct_id': original, 'alias': alias_id, 'token': self._token}}
        if meta:
            event.update(meta)
    ...
    def merge(self, api_key, distinct_id1, distinct_id2, meta=None, api_secret=None):
        ...
        if api_secret is None:
            logger.warning('api_key will soon be removed from mixpanel-python; please use api_secret instead.')
        event = {'event': '$merge', 'properties': {'$distinct_ids': [distinct_id1, distinct_id2], 'token': self._token}}
        if meta:
            event.update(meta)
        self._consumer.send('imports', json_dumps(event, cls=self._serializer), (api_key, api_secret))
    ...
    def people_set(self, distinct_id, properties, meta=None):
        ...
        """
        return self.people_update({'$distinct_id': distinct_id, '$set': properties}, meta=meta or {})
    ...
    def people_set_once(self, distinct_id, properties, meta=None):
        ...
        these properties.
        """
        return self.people_update({'$distinct_id': distinct_id, '$set_once': properties}, meta=meta or {})
    ...
    def people_increment(self, distinct_id, properties, meta=None):
        ...
        """
        return self.people_update({'$distinct_id': distinct_id, '$add': properties}, meta=meta or {})
    ...
    def people_append(self, distinct_id, properties, meta=None):
        ...
        """
        return self.people_update({'$distinct_id': distinct_id, '$append': properties}, meta=meta or {})
    ...
    def people_union(self, distinct_id, properties, meta=None):
        ...
        """
        return self.people_update({'$distinct_id': distinct_id, '$union': properties}, meta=meta or {})
    ...
    def people_unset(self, distinct_id, properties, meta=None):
        ...
        """
        return self.people_update({'$distinct_id': distinct_id, '$unset': properties}, meta=meta)
    ...
    def people_remove(self, distinct_id, properties, meta=None):
        ...
        """
        return self.people_update({'$distinct_id': distinct_id, '$remove': properties}, meta=meta or {})
    ...
    def people_delete(self, distinct_id, meta=None):
        ...
        """
        return self.people_update({'$distinct_id': distinct_id, '$delete': ''}, meta=meta or None)
    ...
    def people_track_charge(self, distinct_id, amount, properties=None, meta=None):
        ...
        return self.people_append(distinct_id, {'$transactions': properties or {}}, meta=meta or {})
    ...
    def people_clear_charges(self, distinct_id, meta=None):
        ...
        """
        return self.people_unset(distinct_id, ['$transactions'], meta=meta or {})
    ...
    def group_set(self, group_key, group_id, properties, meta=None):
        ...
        If the profile does not exist, creates a new profile with these properties.
        """
        return self.group_update({'$group_key': group_key, '$group_id': group_id, '$set': properties}, meta=meta or {})
    ...
    def group_set_once(self, group_key, group_id, properties, meta=None):
        ...
        these properties.
        """
        return self.group_update({'$group_key': group_key, '$group_id': group_id, '$set_once': properties}, meta=meta or {})
    ...
    def group_union(self, group_key, group_id, properties, meta=None):
        ...
        """
        return self.group_update({'$group_key': group_key, '$group_id': group_id, '$union': properties}, meta=meta or {})
    ...
    def group_unset(self, group_key, group_id, properties, meta=None):
        ...
        :param list properties: property names to remove
        """
        return self.group_update({'$group_key': group_key, '$group_id': group_id, '$unset': properties}, meta=meta)
    ...
    def group_remove(self, group_key, group_id, properties, meta=None):
        ...
        """
        return self.group_update({'$group_key': group_key, '$group_id': group_id, '$remove': properties}, meta=meta or {})
    ...
    def group_delete(self, group_key, group_id, meta=None):
        ...
        """
        return self.group_update({'$group_key': group_key, '$group_id': group_id, '$delete': ''}, meta=meta or None)
...
class Consumer(object):
    ...
    def __init__(self, events_url=None, people_url=None, import_url=None, request_timeout=None, groups_url=None, api_host='api.mixpanel.com', retry_limit=4, retry_backoff_factor=0.25, verify_cert=True):
        self._endpoints = {'events': events_url or 'https://{}/track'.format(api_host), 'people': people_url or 'https://{}/engage'.format(api_host), 'groups': groups_url or 'https://{}/groups'.format(api_host), 'imports': import_url or 'https://{}/import'.format(api_host)}
        ...
        retry_args = {'total': retry_limit, 'backoff_factor': retry_backoff_factor, 'status_forcelist': set(range(500, 600)), methods_arg: {'POST'}}
        adapter = requests.adapters.HTTPAdapter(max_retries=urllib3.Retry(**retry_args))
    ...
    def _write_request(self, request_url, json_message, api_key=None, api_secret=None):
        ...
        try:
            response = self._session.post(request_url, data=params, auth=basic_auth, timeout=self._request_timeout, verify=self._verify_cert)
...
class BufferedConsumer(object):
    ...
    def __init__(self, max_size=50, events_url=None, people_url=None, import_url=None, request_timeout=None, groups_url=None, api_host='api.mixpanel.com', retry_limit=4, retry_backoff_factor=0.25, verify_cert=True):
        self._consumer = Consumer(events_url, people_url, import_url, request_timeout, groups_url, api_host, retry_limit, retry_backoff_factor, verify_cert)
        self._buffers = {'events': [], 'people': [], 'groups': [], 'imports': []}
