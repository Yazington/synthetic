...
def _generate_installed_modules(): # type: () -> Iterator[Tuple[str, str]]
    try:
...
def _get_installed_modules(): # type: () -> Dict[str, str]
...
class ModulesIntegration(Integration):
    ...
    def setup_once(): # type: () -> None
        ...
        def processor(event, hint): # type: (Event, Any) -> Dict[str, Any]
