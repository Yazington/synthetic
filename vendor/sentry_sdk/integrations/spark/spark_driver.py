...
def _set_app_properties(): # type: () -> None
    """
...
def _start_sentry_listener(sc): # type: (Any) -> None
    """
...
def patch_spark_context_init(): # type: () -> None
    from pyspark import SparkContext
    spark_context_init = SparkContext._do_init

    def _sentry_patched_spark_context_init(self, *args, **kwargs): # type: (SparkContext, *Any, **Any) -> Optional[Any]
...
class SparkListener(object):
    ...
    def onApplicationEnd(self, applicationEnd): # type: (Any) -> None
        pass

    def onApplicationStart(self, applicationStart): # type: (Any) -> None
        pass

    def onBlockManagerAdded(self, blockManagerAdded): # type: (Any) -> None
        pass

    def onBlockManagerRemoved(self, blockManagerRemoved): # type: (Any) -> None
        pass

    def onBlockUpdated(self, blockUpdated): # type: (Any) -> None
        pass

    def onEnvironmentUpdate(self, environmentUpdate): # type: (Any) -> None
        pass

    def onExecutorAdded(self, executorAdded): # type: (Any) -> None
        pass

    def onExecutorBlacklisted(self, executorBlacklisted): # type: (Any) -> None
        pass

    def onExecutorBlacklistedForStage(self, executorBlacklistedForStage): # type: (Any) -> None
        pass

    def onExecutorMetricsUpdate(self, executorMetricsUpdate): # type: (Any) -> None
        pass

    def onExecutorRemoved(self, executorRemoved): # type: (Any) -> None
        pass

    def onJobEnd(self, jobEnd): # type: (Any) -> None
        pass

    def onJobStart(self, jobStart): # type: (Any) -> None
        pass

    def onNodeBlacklisted(self, nodeBlacklisted): # type: (Any) -> None
        pass

    def onNodeBlacklistedForStage(self, nodeBlacklistedForStage): # type: (Any) -> None
        pass

    def onNodeUnblacklisted(self, nodeUnblacklisted): # type: (Any) -> None
        pass

    def onOtherEvent(self, event): # type: (Any) -> None
        pass

    def onSpeculativeTaskSubmitted(self, speculativeTask): # type: (Any) -> None
        pass

    def onStageCompleted(self, stageCompleted): # type: (Any) -> None
        pass

    def onStageSubmitted(self, stageSubmitted): # type: (Any) -> None
        pass

    def onTaskEnd(self, taskEnd): # type: (Any) -> None
        pass

    def onTaskGettingResult(self, taskGettingResult): # type: (Any) -> None
        pass

    def onTaskStart(self, taskStart): # type: (Any) -> None
        pass

    def onUnpersistRDD(self, unpersistRDD): # type: (Any) -> None
        pass
