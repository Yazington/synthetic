...
def patch_django_middlewares(): # type: () -> None
    from django.core.handlers import base
    old_import_string = getattr(base, import_string_name)

    def sentry_patched_import_string(dotted_path): # type: (str) -> Any
    ...
    def sentry_patched_load_middleware(*args, **kwargs): # type: (Any, Any) -> Any
...
def _wrap_middleware(middleware, middleware_name): # type: (Any, str) -> Any
    from ....sentry_sdk.integrations.django import DjangoIntegration

    def _check_middleware_span(old_method): # type: (Callable[..., Any]) -> Optional[Span]
        hub = Hub.current
    ...
    def _get_wrapped_method(old_method): # type: (F) -> F
        with capture_internal_exceptions():

            def sentry_wrapped_method(*args, **kwargs): # type: (*Any, **Any) -> Any
    ...
    class SentryWrappingMiddleware(_asgi_middleware_mixin_factory(_check_middleware_span)):
        ...
        def __init__(self, get_response=None, *args, **kwargs): # type: (Optional[Callable[..., Any]], *Any, **Any) -> None
            if get_response:
        ...
        def __getattr__(self, method_name): # type: (str) -> Any
