...
def get_regex(resolver_or_pattern): # type: (Union[URLPattern, URLResolver]) -> Pattern[str]
...
class RavenResolver(object):
    ...
    def _simplify(self, pattern): # type: (str) -> str
        """
    ...
    def _resolve(self, resolver, path, parents=None): # type: (URLResolver, str, Optional[List[URLResolver]]) -> Optional[str]
    ...
    def resolve(self, path, urlconf=None): # type: (...) -> str
