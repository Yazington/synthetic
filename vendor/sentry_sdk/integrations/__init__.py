...
def _generate_default_integrations_iterator(integrations, auto_enabling_integrations): # type: (Tuple[str, ...], Tuple[str, ...]) -> Callable[[bool], Iterator[Type[Integration]]]

    def iter_default_integrations(with_auto_enabling_integrations): # type: (bool) -> Iterator[Type[Integration]]
...
_AUTO_ENABLING_INTEGRATIONS = ('sentry_sdk.integrations.django.DjangoIntegration', 'sentry_sdk.integrations.flask.FlaskIntegration', 'sentry_sdk.integrations.bottle.BottleIntegration', 'sentry_sdk.integrations.falcon.FalconIntegration', 'sentry_sdk.integrations.sanic.SanicIntegration', 'sentry_sdk.integrations.celery.CeleryIntegration', 'sentry_sdk.integrations.rq.RqIntegration', 'sentry_sdk.integrations.aiohttp.AioHttpIntegration', 'sentry_sdk.integrations.tornado.TornadoIntegration', 'sentry_sdk.integrations.sqlalchemy.SqlalchemyIntegration', 'sentry_sdk.integrations.boto3.Boto3Integration')
iter_default_integrations = _generate_default_integrations_iterator(integrations=('sentry_sdk.integrations.logging.LoggingIntegration', 'sentry_sdk.integrations.stdlib.StdlibIntegration', 'sentry_sdk.integrations.excepthook.ExcepthookIntegration', 'sentry_sdk.integrations.dedupe.DedupeIntegration', 'sentry_sdk.integrations.atexit.AtexitIntegration', 'sentry_sdk.integrations.modules.ModulesIntegration', 'sentry_sdk.integrations.argv.ArgvIntegration', 'sentry_sdk.integrations.threading.ThreadingIntegration'), auto_enabling_integrations=_AUTO_ENABLING_INTEGRATIONS)
del _generate_default_integrations_iterator

def setup_integrations(integrations, with_defaults=True, with_auto_enabling_integrations=False): # type: (List[Integration], bool, bool) -> Dict[str, Integration]
