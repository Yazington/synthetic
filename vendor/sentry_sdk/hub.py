...
def _update_scope(base, scope_change, scope_kwargs): # type: (Scope, Optional[Any], Dict[str, Any]) -> Scope
...
def _should_send_default_pii(): # type: () -> bool
...
class _InitGuard(object):
    ...
    def __enter__(self): # type: () -> _InitGuard
        return self
...
def _init(*args, **kwargs): # type: (*Optional[str], **Any) -> ContextManager[Any]
...
class HubMeta(type):
    ...
    @property
    def main(cls): # type: () -> Hub
        """Returns the main instance of the hub."""
        return GLOBAL_HUB

class _ScopeManager(object):

    def __init__(self, hub): # type: (Hub) -> None
        self._hub = hub
        self._original_len = len(hub._stack)
        self._layer = hub._stack[-1]

    def __enter__(self): # type: () -> Scope
        scope = self._layer[1]
...
class Hub(with_metaclass(HubMeta)):
    ...
    def __init__(self, client_or_hub=None, scope=None): # type: (...) -> None
    ...
    def __enter__(self): # type: () -> Hub
        self._old_hubs.append(Hub.current)
        _local.set(self)
        return self

    def __exit__(self, exc_type, exc_value, tb): # type: (...) -> None
        old = self._old_hubs.pop()
        _local.set(old)

    def run(self, callback): # type: (...) -> T
    ...
    def get_integration(self, name_or_class): # type: (...) -> Any
    ...
    @property
    def client(self): # type: () -> Optional[Client]
    ...
    def last_event_id(self): # type: () -> Optional[str]
        """Returns the last event ID."""
        return self._last_event_id

    def bind_client(self, new): # type: (...) -> None
        """Binds a new client to the hub."""
        top = self._stack[-1]
        self._stack[-1] = (new, top[1])

    def capture_event(self, event, hint=None, scope=None, **scope_args): # type: (...) -> Optional[str]
    ...
    def capture_message(self, message, level=None, scope=None, **scope_args): # type: (...) -> Optional[str]
        ...
        if level is None:
            level = 'info'
        return self.capture_event({'message': message, 'level': level}, scope=scope, **scope_args)

    def capture_exception(self, error=None, scope=None, **scope_args): # type: (...) -> Optional[str]
    ...
    def _capture_internal_exception(self, exc_info): # type: (...) -> Any
        """
    ...
    def add_breadcrumb(self, crumb=None, hint=None, **kwargs): # type: (...) -> None
        """
        Adds a breadcrumb.
    ...
    def start_span(self, span=None, **kwargs): # type: (...) -> Span
        """
        ...
        if isinstance(span, Transaction) or 'transaction' in kwargs:
            deprecation_msg = 'Deprecated: use start_transaction to start transactions and Transaction.start_child to start spans.'
    ...
    def start_transaction(self, transaction=None, **kwargs): # type: (...) -> Transaction
        """
        ...
        sampling_context = {'transaction_context': transaction.to_json(), 'parent_sampled': transaction.parent_sampled}
        sampling_context.update(custom_sampling_context)
        transaction._set_initial_sampling_decision(sampling_context=sampling_context)
        if transaction.sampled:
            max_spans = self.client and self.client.options['_experiments'].get('max_spans') or 1000
            transaction.init_span_recorder(maxlen=max_spans)
        return transaction

    @overload
    def push_scope(self, callback=None): # type: (...) -> ContextManager[Scope]
        pass

    @overload
    def push_scope(self, callback): # type: (...) -> None
        pass

    def push_scope(self, callback=None): # type: (...) -> Optional[ContextManager[Scope]]
        """
    ...
    @overload
    def configure_scope(self, callback=None): # type: (...) -> ContextManager[Scope]
        pass

    @overload
    def configure_scope(self, callback): # type: (...) -> None
        pass

    def configure_scope(self, callback=None): # type: (...) -> Optional[ContextManager[Scope]]
        """
        ...
        @contextmanager
        def inner(): # type: () -> Generator[Scope, None, None]
            if client is not None:
                yield scope
            else:
                yield Scope()
    ...
    def start_session(self, session_mode='application'): # type: (...) -> None
        """Starts a new session."""
        self.end_session()
        (client, scope) = self._stack[-1]
        scope._session = Session(release=client.options['release'] if client else None, environment=client.options['environment'] if client else None, user=scope._user, session_mode=session_mode)

    def end_session(self): # type: (...) -> None
    ...
    def stop_auto_session_tracking(self): # type: (...) -> None
    ...
    def resume_auto_session_tracking(self): # type: (...) -> None
    ...
    def iter_trace_propagation_headers(self, span=None): # type: (Optional[Span]) -> Generator[Tuple[str, str], None, None]
        """
