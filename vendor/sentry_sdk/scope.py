...
if MYPY:
    ...
    from ..sentry_sdk._types import Breadcrumb, Event, EventProcessor, ErrorProcessor, ExcInfo, Hint, Type
...
def add_global_event_processor(processor): # type: (EventProcessor) -> None
    global_event_processors.append(processor)

def _attr_setter(fn): # type: (Any) -> Any
    return property(fset=fn, doc=fn.__doc__)

def _disable_capture(fn): # type: (F) -> F

    @wraps(fn)
    def wrapper(self, *args, **kwargs): # type: (Any, *Dict[str, Any], **Any) -> Any
...
class Scope(object):
    ...
    """
    __slots__ = ('_level', '_name', '_fingerprint', '_transaction', '_user', '_tags', '_contexts', '_extras', '_breadcrumbs', '_event_processors', '_error_processors', '_should_capture', '_span', '_session', '_attachments', '_force_auto_session_tracking')
    ...
    @_attr_setter
    def level(self, value): # type: (Optional[str]) -> None
        """When set this overrides the level. Deprecated in favor of set_level."""
        self._level = value

    def set_level(self, value): # type: (Optional[str]) -> None
        """Sets the level for the scope."""
        self._level = value

    @_attr_setter
    def fingerprint(self, value): # type: (Optional[List[str]]) -> None
        """When set this overrides the default fingerprint."""
        self._fingerprint = value

    @property
    def transaction(self): # type: () -> Any
    ...
    @transaction.setter
    def transaction(self, value): # type: (Any) -> None
    ...
    @_attr_setter
    def user(self, value): # type: (Optional[Dict[str, Any]]) -> None
        """When set a specific user is bound to the scope. Deprecated in favor of set_user."""
        self.set_user(value)

    def set_user(self, value): # type: (Optional[Dict[str, Any]]) -> None
    ...
    @property
    def span(self): # type: () -> Optional[Span]
        """Get/set current tracing span or transaction."""
        return self._span

    @span.setter
    def span(self, span): # type: (Optional[Span]) -> None
        self._span = span
    ...
    def set_tag(self, key, value): # type: (...) -> None
        """Sets a tag for a key to a specific value."""
        self._tags[key] = value

    def remove_tag(self, key): # type: (...) -> None
        """Removes a specific tag."""
        self._tags.pop(key, None)

    def set_context(self, key, value): # type: (...) -> None
        """Binds a context at a certain key to a specific value."""
        self._contexts[key] = value

    def remove_context(self, key): # type: (...) -> None
        """Removes a context."""
        self._contexts.pop(key, None)

    def set_extra(self, key, value): # type: (...) -> None
        """Sets an extra key to a specific value."""
        self._extras[key] = value

    def remove_extra(self, key): # type: (...) -> None
        """Removes a specific extra key."""
        self._extras.pop(key, None)

    def clear_breadcrumbs(self): # type: () -> None
        """Clears breadcrumb buffer."""
        self._breadcrumbs = deque() # type: Deque[Breadcrumb]

    def add_attachment(self, bytes=None, filename=None, path=None, content_type=None, add_to_transactions=False): # type: (...) -> None
    ...
    def add_event_processor(self, func): # type: (...) -> None
    ...
    def add_error_processor(self, func, cls=None): # type: (...) -> None
        ...
        if cls is not None:
            ...
            def func(event, exc_info): # type: (Event, ExcInfo) -> Optional[Event]
                try:
    ...
    @_disable_capture
    def apply_to_event(self, event, hint): # type: (...) -> Optional[Event]
        """Applies the information contained on the scope to the given event."""

        def _drop(event, cause, ty): # type: (Dict[str, Any], Any, str) -> Optional[Any]
        ...
        if not is_transaction:
            event.setdefault('breadcrumbs', {}).setdefault('values', []).extend(self._breadcrumbs)
    ...
    def update_from_scope(self, scope): # type: (Scope) -> None
    ...
    def update_from_kwargs(self, user=None, level=None, extras=None, contexts=None, tags=None, fingerprint=None): # type: (...) -> None
