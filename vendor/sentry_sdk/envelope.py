...
def parse_json(data): # type: (Union[bytes, text_type]) -> Any
...
class Envelope(object):
    ...
    def __init__(self, headers=None, items=None): # type: (...) -> None
    ...
    def get_transaction_event(self): # type: (...) -> Optional[Event]
    ...
    def __iter__(self): # type: (...) -> Iterator[Item]
        return iter(self.items)

    def serialize_into(self, f): # type: (...) -> None
    ...
    @classmethod
    def deserialize_from(cls, f): # type: (...) -> Envelope
    ...
    @classmethod
    def deserialize(cls, bytes): # type: (...) -> Envelope
...
class PayloadRef(object):
    ...
    def __init__(self, bytes=None, path=None, json=None): # type: (...) -> None
        self.json = json
        self.bytes = bytes
        self.path = path

    def get_bytes(self): # type: (...) -> bytes
    ...
    @property
    def inferred_content_type(self): # type: (...) -> str
...
class Item(object):
    ...
    def __init__(self, payload, headers=None, type=None, content_type=None, filename=None):
        if headers is not None:
            headers = dict(headers)
    ...
    def __repr__(self): # type: (...) -> str
        return '<Item headers=%r payload=%r data_category=%r>' % (self.headers, self.payload, self.data_category)
    ...
    @property
    def data_category(self): # type: (...) -> EventDataCategory
    ...
    @classmethod
    def deserialize_from(cls, f): # type: (...) -> Optional[Item]
    ...
    @classmethod
    def deserialize(cls, bytes): # type: (...) -> Optional[Item]
        return cls.deserialize_from(io.BytesIO(bytes))
