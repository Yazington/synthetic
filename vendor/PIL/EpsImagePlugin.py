...
def Ghostscript(tile: list[ImageFile._Tile], size: tuple[int, int], fp: IO[bytes], scale: int=1, transparency: bool=False) -> Image.core.ImagingCore:
...
class EpsImageFile(ImageFile.ImageFile):
    ...
    def _open(self) -> None:
        ...
        if not bounding_box:
            ...
            raise OSError(msg)
        self._size = imagedata_size or (bounding_box[2] - bounding_box[0], bounding_box[3] - bounding_box[1])
