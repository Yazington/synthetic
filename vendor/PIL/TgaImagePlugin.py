...
MODES = {(1, 8): 'P', (3, 1): '1', (3, 8): 'L', (3, 16): 'LA', (2, 16): 'BGRA;15Z', (2, 24): 'BGR', (2, 32): 'BGRA'}
...
class TgaImageFile(ImageFile.ImageFile):
    ...
    def _open(self) -> None:
        ...
        try:
            ...
            if imagetype & 8:
                self.tile = [ImageFile._Tile('tga_rle', (0, 0) + self.size, self.fp.tell(), (rawmode, orientation, depth))]
            else:
                self.tile = [ImageFile._Tile('raw', (0, 0) + self.size, self.fp.tell(), (rawmode, 0, orientation))]
        except KeyError:
            pass
...
def _save(im: Image.Image, fp: IO[bytes], filename: str | bytes) -> None:
    ...
    if colormaptype:
        fp.write(palette)
    if rle:
        ImageFile._save(im, fp, [ImageFile._Tile('tga_rle', (0, 0) + im.size, 0, (rawmode, orientation))])
    else:
        ImageFile._save(im, fp, [ImageFile._Tile('raw', (0, 0) + im.size, 0, (rawmode, 0, orientation))])
