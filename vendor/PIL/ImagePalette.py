...
class ImagePalette:
    ...
    def getcolor(self, color: tuple[int, ...], image: Image.Image | None=None) -> int:
...
def load(filename: str) -> tuple[bytes, str]:
    with open(filename, 'rb') as fp:
        paletteHandlers: list[type[GimpPaletteFile.GimpPaletteFile | GimpGradientFile.GimpGradientFile | PaletteFile.PaletteFile]] = [GimpPaletteFile.GimpPaletteFile, GimpGradientFile.GimpGradientFile, PaletteFile.PaletteFile]
