...
def _parse_jp2_header(fp: IO[bytes]) -> tuple[tuple[int, int], str, str | None, tuple[float, float] | None, ImagePalette.ImagePalette | None]:
    ...
    def _open(self) -> None:
        ...
        try:
            ...
            try:
                ...
                length = -1
        self.tile = [ImageFile._Tile('jpeg2k', (0, 0) + self.size, 0, (self.codec, self._reduce, self.layers, fd, length))]
