...
class _Operand:
    ...
    def apply(self, op: str, im1: _Operand | float, im2: _Operand | float | None=None, mode: str | None=None) -> _Operand:
...
ops = {'int': imagemath_int, 'float': imagemath_float, 'equal': imagemath_equal, 'notequal': imagemath_notequal, 'min': imagemath_min, 'max': imagemath_max, 'convert': imagemath_convert}
...
def lambda_eval(expression: Callable[[dict[str, Any]], Any], options: dict[str, Any]={}, **kw: Any) -> Any:
    ...
    """
    if options:
        deprecate('ImageMath.lambda_eval options', 12, 'ImageMath.lambda_eval keyword arguments')
...
def unsafe_eval(expression: str, options: dict[str, Any]={}, **kw: Any) -> Any:
    ...
    """
    if options:
        deprecate('ImageMath.unsafe_eval options', 12, 'ImageMath.unsafe_eval keyword arguments')
    args: dict[str, Any] = ops.copy()
...
def eval(expression: str, _dict: dict[str, Any]={}, **kw: Any) -> Any:
    ...
    ..  deprecated:: 10.3.0
    """
    deprecate('ImageMath.eval', 12, 'ImageMath.lambda_eval or ImageMath.unsafe_eval')
