...
class BmpImageFile(ImageFile.ImageFile):
    ...
    def _bitmap(self, header: int=0, offset: int=0) -> None:
        ...
        if header:
            seek(header)
        file_info: dict[str, bool | int | tuple[int, ...]] = {'header_size': i32(read(4)), 'direction': -1}
        ...
        decoder_name = 'raw'
        if file_info['compression'] == self.COMPRESSIONS['BITFIELDS']:
            SUPPORTED: dict[int, list[tuple[int, ...]]] = {32: [(16711680, 65280, 255, 0), (4278190080, 16711680, 65280, 0), (4278190080, 65280, 255, 0), (4278190080, 16711680, 65280, 255), (255, 65280, 16711680, 4278190080), (16711680, 65280, 255, 4278190080), (4278190080, 65280, 255, 16711680), (0, 0, 0, 0)], 24: [(16711680, 65280, 255)], 16: [(63488, 2016, 31), (31744, 992, 31)]}
            MASK_MODES = {(32, (16711680, 65280, 255, 0)): 'BGRX', (32, (4278190080, 16711680, 65280, 0)): 'XBGR', (32, (4278190080, 65280, 255, 0)): 'BGXR', (32, (4278190080, 16711680, 65280, 255)): 'ABGR', (32, (255, 65280, 16711680, 4278190080)): 'RGBA', (32, (16711680, 65280, 255, 4278190080)): 'BGRA', (32, (4278190080, 65280, 255, 16711680)): 'BGAR', (32, (0, 0, 0, 0)): 'BGRA', (24, (16711680, 65280, 255)): 'BGR', (16, (63488, 2016, 31)): 'BGR;16', (16, (31744, 992, 31)): 'BGR;15'}
        ...
        elif file_info['compression'] in (self.COMPRESSIONS['RLE8'], self.COMPRESSIONS['RLE4']):
        ...
        self.tile = [ImageFile._Tile(decoder_name, (0, 0, file_info['width'], file_info['height']), offset or self.fp.tell(), tuple(args))]
